...
$benefits = array(
	array( 'emoji' => '🌿', 'bg' => '#bfe3d2', 'title' => kawami_field( 'kawami_jr_benefit1_title' ), 'text' => kawami_field( 'kawami_jr_benefit1_text' ) ),
	array( 'emoji' => '💗', 'bg' => '#f8cdd8', 'title' => kawami_field( 'kawami_jr_benefit2_title' ), 'text' => kawami_field( 'kawami_jr_benefit2_text' ) ),
	array( 'emoji' => '📚', 'bg' => '#d5c3e8', 'title' => kawami_field( 'kawami_jr_benefit3_title' ), 'text' => kawami_field( 'kawami_jr_benefit3_text' ) ),
	array( 'emoji' => '🌸', 'bg' => '#fce3c8', 'title' => kawami_field( 'kawami_jr_benefit4_title' ), 'text' => kawami_field( 'kawami_jr_benefit4_text' ) ),
);
$premiers = array(
	array( 'name' => kawami_field( 'kawami_jr_premier1_name' ), 'sous' => kawami_field( 'kawami_jr_premier1_sous' ), 'desc' => kawami_field( 'kawami_jr_premier1_desc' ), 'image' => kawami_field_image( 'kawami_jr_gratitude_image' ) ),
	array( 'name' => kawami_field( 'kawami_jr_premier2_name' ), 'sous' => kawami_field( 'kawami_jr_premier2_sous' ), 'desc' => kawami_field( 'kawami_jr_premier2_desc' ), 'image' => kawami_field_image( 'kawami_jr_lectures_image' ) ),
);
$a_venir = array(
	array( 'emoji' => '🫧', 'bg' => '#d5c3e8', 'name' => kawami_field( 'kawami_jr_avenir1_name' ), 'desc' => kawami_field( 'kawami_jr_avenir1_desc' ) ),
	array( 'emoji' => '☀️', 'bg' => '#bfe3d2', 'name' => kawami_field( 'kawami_jr_avenir2_name' ), 'desc' => kawami_field( 'kawami_jr_avenir2_desc' ) ),
);
$goodies = array(
	array( 'emoji' => '🔖', 'bg' => '#f8cdd8', 'name' => kawami_field( 'kawami_jr_goodie1_name' ), 'text' => kawami_field( 'kawami_jr_goodie1_text' ) ),
	array( 'emoji' => '📖', 'bg' => '#d5c3e8', 'name' => kawami_field( 'kawami_jr_goodie2_name' ), 'text' => kawami_field( 'kawami_jr_goodie2_text' ) ),
	array( 'emoji' => '✏️', 'bg' => '#bfe3d2', 'name' => kawami_field( 'kawami_jr_goodie3_name' ), 'text' => kawami_field( 'kawami_jr_goodie3_text' ) ),
);
?>
...
<section class="k-container" style="padding: 0 40px 30px">
	<div class="k-journal-hero" style="position: relative; height: 540px; border-radius: 30px; overflow: hidden; border: 10px solid #fff; box-shadow: 0 18px 44px rgba(92,67,81,.16)">
		...
		<div class="k-journal-hero__overlay" style="position: absolute; left: 0; top: 0; bottom: 0; max-width: 600px; padding: 0 8%; display: flex; flex-direction: column; justify-content: center; gap: 14px">
			<div style="display: inline-flex; align-self: flex-start; align-items: center; gap: 8px; background: rgba(253,243,244,.92); border-radius: 999px; padding: 7px 16px; font: 700 11px var(--k-font-ui); letter-spacing: .18em; color: #c76b88; text-transform: uppercase"><?php echo esc_html( kawami_field( 'kawami_jr_hero_eyebrow' ) ); ?></div>
			<h1 class="k-journal-hero__title" style="font: 900 46px/1.16 var(--k-font-title); color: #fff; margin: 0; text-wrap: pretty; text-shadow: 0 2px 14px rgba(0,0,0,.35)"><?php echo esc_html( kawami_field( 'kawami_jr_hero_title' ) ); ?></h1>
			<div class="k-italic-accent k-journal-hero__subtitle" style="font-size: 21px; color: #fff; text-shadow: 0 2px 10px rgba(0,0,0,.35)"><?php echo esc_html( kawami_field( 'kawami_jr_hero_subtitle' ) ); ?></div>
			<p style="font: 500 14px/1.6 var(--k-font-ui); color: #fff; margin: 0; max-width: 460px; text-shadow: 0 1px 8px rgba(0,0,0,.3)"><?php echo esc_html( kawami_field( 'kawami_jr_hero_text' ) ); ?></p>
		</div>
	</div>
</section>
...
<section class="k-container" style="padding: 20px 40px 10px">
	<div style="text-align: center; max-width: 640px; margin: 0 auto 26px">
		<h2 style="font: 900 30px var(--k-font-title); color: var(--k-text); margin: 0 0 10px"><?php echo esc_html( kawami_field( 'kawami_jr_why_title' ) ); ?></h2>
		<p style="font: 500 14px/1.7 var(--k-font-ui); color: var(--k-text-soft); margin: 0"><?php echo esc_html( kawami_field( 'kawami_jr_why_text' ) ); ?></p>
	</div>
...
<section class="k-container" style="padding: 44px 40px 10px">
	<div style="display: flex; align-items: baseline; gap: 14px; margin-bottom: 6px; flex-wrap: wrap">
		<h2 style="font: 900 26px var(--k-font-title); color: var(--k-text); margin: 0"><?php echo esc_html( kawami_field( 'kawami_jr_premiers_title' ) ); ?></h2>
		<span style="font: 600 13px var(--k-font-ui); color: var(--k-text-muted)"><?php echo esc_html( kawami_field( 'kawami_jr_premiers_tag' ) ); ?></span>
	</div>
	<p style="font: 500 13.5px var(--k-font-ui); color: var(--k-text-soft); margin: 0 0 22px"><?php echo esc_html( kawami_field( 'kawami_jr_premiers_text' ) ); ?></p>
...
<section class="k-container" style="padding: 40px 40px 10px">
	<div style="display: flex; align-items: baseline; gap: 14px; margin-bottom: 18px; flex-wrap: wrap">
		<h2 style="font: 900 26px var(--k-font-title); color: var(--k-text); margin: 0"><?php echo esc_html( kawami_field( 'kawami_jr_avenir_title' ) ); ?></h2>
		<span style="font: 600 13px var(--k-font-ui); color: var(--k-text-muted)"><?php echo esc_html( kawami_field( 'kawami_jr_avenir_tag' ) ); ?></span>
	</div>
...
<section class="k-container k-split" style="padding: 40px 40px 6px; display: grid; grid-template-columns: 1.1fr .9fr; gap: 30px; align-items: center">
	...
	<div style="display: flex; flex-direction: column; gap: 16px">
		<div style="font: 700 11px var(--k-font-ui); letter-spacing: .2em; color: var(--k-text-muted); text-transform: uppercase"><?php echo esc_html( kawami_field( 'kawami_jr_feature_eyebrow' ) ); ?></div>
		<h2 style="font: 900 27px/1.2 var(--k-font-title); color: var(--k-text); margin: 0; text-wrap: pretty"><?php echo esc_html( kawami_field( 'kawami_jr_feature_title' ) ); ?></h2>
		<div style="background: var(--k-card); border: 1.5px solid var(--k-border); border-radius: 18px; padding: 18px 22px; display: flex; gap: 12px; align-items: center">
			...
			<span style="font: 600 13.5px/1.5 var(--k-font-ui); color: var(--k-text)"><?php echo esc_html( kawami_field( 'kawami_jr_feature1_text' ) ); ?></span>
		</div>
		<div style="background: var(--k-card); border: 1.5px solid var(--k-border); border-radius: 18px; padding: 18px 22px; display: flex; gap: 12px; align-items: center">
			<span style="font-size: 22px; flex: none">📖</span>
			<span style="font: 600 13.5px/1.5 var(--k-font-ui); color: var(--k-text)"><?php echo esc_html( kawami_field( 'kawami_jr_feature2_text' ) ); ?></span>
		</div>
		<div style="background: var(--k-card); border: 1.5px solid var(--k-border); border-radius: 18px; padding: 18px 22px; display: flex; gap: 12px; align-items: center">
			<span style="font-size: 22px; flex: none">📄</span>
			<span style="font: 600 13.5px/1.5 var(--k-font-ui); color: var(--k-text)"><?php echo esc_html( kawami_field( 'kawami_jr_feature3_text' ) ); ?></span>
		</div>
	</div>
</section>
...
<section class="k-container" style="padding: 44px 40px 10px">
	<div style="display: flex; align-items: baseline; gap: 14px; margin-bottom: 6px">
		<h2 style="font: 900 26px var(--k-font-title); color: var(--k-text); margin: 0"><?php echo esc_html( kawami_field( 'kawami_jr_goodies_title' ) ); ?></h2>
	</div>
	<p style="font: 500 13.5px var(--k-font-ui); color: var(--k-text-soft); margin: 0 0 22px"><?php echo esc_html( kawami_field( 'kawami_jr_goodies_text' ) ); ?></p>
...
<?php get_template_part( 'template-parts/coming-soon', 'newsletter', array(
	'title'    => kawami_field( 'kawami_jr_nl_title' ),
	'text'     => kawami_field( 'kawami_jr_nl_text' ),
	'bg_image' => $cta_image,
) ); ?>
